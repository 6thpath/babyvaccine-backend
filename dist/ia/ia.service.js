...
let IaService = class IaService {
    ...
    ias() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.iaModel.find({ isEnabled: true });
            }
            catch (_a) {
    ...
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.iaModel.updateOne({ _id: data.id }, data);
    ...
    delete(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.iaModel.updateOne({ _id: data.id }, { isEnabled: false });
...
IaService = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject('IaModelToken')),
